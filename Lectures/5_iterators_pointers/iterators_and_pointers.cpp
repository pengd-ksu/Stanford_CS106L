...
int main() {
    ...
    cout << "Peng, Raw value of (void*) pointerToX: " << (void*)pointerToX << endl;
    cout << "Raw value of pointerToX: " << pointerToX << endl;
    cout << "Value of x: " << x << ", value of integer pointed to by pointerToX: " << *pointerToX << endl << endl;
    ...
    cout << "After increment: Value of pointerToVec: " << *pointerToVec << ", value of vectorIterator: " << *vectorIterator << endl << endl;
